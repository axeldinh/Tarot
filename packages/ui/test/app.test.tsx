    ...
    const saved = {
      ...
      session: {
        ...newSession({
          ...
          playerCount: 4,
          seats: [
            { seat: 0, name: 'Moi', kind: 'human' as const, connected: true },
            { seat: 1, name: 'B1', kind: 'bot' as const, connected: true },
            { seat: 2, name: 'B2', kind: 'bot' as const, connected: true },
            { seat: 3, name: 'B3', kind: 'bot' as const, connected: true },
          ],
          dealer: 1,
        }),
        totals: [30, -10, -10, -10],
