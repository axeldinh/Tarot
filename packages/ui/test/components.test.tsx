...
describe('the score breakdown', () => {
  const session: SessionSnapshot = {
    ...newSession({
      ...
      playerCount: 4,
      seats: [
        { seat: 0, name: 'Moi', kind: 'human', connected: true },
        { seat: 1, name: 'B1', kind: 'bot', connected: true },
        { seat: 2, name: 'B2', kind: 'bot', connected: true },
        { seat: 3, name: 'B3', kind: 'bot', connected: true },
      ],
      dealer: 0,
    }),
    totals: [-72, -72, -72, 216],
